...
set -x
xrandr --delmode HDMI1 1280x800_60
xrandr --rmmode 1280x800_60
xrandr --newmode 1280x800_60 83.46  1280 1344 1480 1680  800 801 804 828  -HSync +Vsync
xrandr --addmode HDMI1 1280x800_60
xrandr --dpi 96x96 --output HDMI1 --mode 1280x800_60 --pos 1366x0 --rotate left --output LVDS1 --primary --mode 1366x768 --pos 0x512 --rotate normal --output VIRTUAL1 --off --output DP1 --off --output VGA1 --off
