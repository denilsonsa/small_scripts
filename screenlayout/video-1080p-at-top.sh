...
xrandr --dpi 96x96 --output HDMI-1 --mode 1920x1080 --pos 0x0 --rotate normal --output LVDS-1 --mode 1366x768 --pos 554x1080 --rotate normal --primary --output VIRTUAL-1 --off --output DP-1 --off --output VGA-1 --off
