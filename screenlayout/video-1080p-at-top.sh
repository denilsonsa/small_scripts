...
xrandr --dpi 96x96 --output HDMI1 --mode 1920x1080 --pos 0x0 --rotate normal --output LVDS1 --mode 1366x768 --pos 554x1080 --rotate normal --primary --output VIRTUAL1 --off --output DP1 --off --output VGA1 --off
