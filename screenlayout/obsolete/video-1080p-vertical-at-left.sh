#!/bin/sh
# META:ICON = "video-1080p-vertical-at-left.png"
xrandr --dpi 96x96 --output LVDS-1 --primary --mode 1366x768 --pos 1080x1152 --rotate normal --output DP-1 --off --output HDMI-1 --mode 1920x1080 --pos 0x0 --rotate left --output VGA-1 --off
